# Get 1 to 255 - 
# Write a function that returns an list with all the numbers from 1 to 255.

#write a function
def get_1_to_255():
    #make a list
    list = []
    #get numbers from 1 - 255
    for i in range(1,256):
        #put all 1-255 numbers in list
        list.append(i)
    #return an list
    return list
...
#write a function
#give list with many values
def negatives(lst):
    #go through the list and find negatives
    for i in range(len(lst)):
        #replace negative numbers with 0
            #get each element
            #what does negative mean? < 0
            #is the element nagative?
            #If element is negative replace with 0
            if lst[i] < 0:
                lst[i] = 0
        #list should have 0 haha negatives
    # return list
    return lst

print(negatives([1,-5,10,-2, 1, 2,34 ,5 ,-109239439]))
